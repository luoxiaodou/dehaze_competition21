...
parser.add_argument('--input_dir', default='./data/NTIRE2021_Test_Hazy/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/NTIRE2021_Test_Hazy-dilated6-512-overlap-390/', type=str, help='Directory for results')
parser.add_argument('--weights', default='./checkpoints/model_epoch_390.pth', type=str, help='Path to weights')
    ...
    for ii, data_test in enumerate(tqdm(test_loader), 0):
        ...
        if args.save_images:
            for batch in range(len(rgb_gt)):
                ...
                print(args.result_dir + filenames[batch][:-4] + '.png')
