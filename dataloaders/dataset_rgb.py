...
class DataLoaderTrain(Dataset):
    def __init__(self, rgb_dir, img_options=None, target_transform=None):
        ...
        clean_files = sorted(os.listdir(os.path.join(rgb_dir, 'NTIRE2021_Train_HazeFree')))
        noisy_files = sorted(os.listdir(os.path.join(rgb_dir, 'NTIRE2021_Train_Hazy')))
        
        self.clean_filenames = [os.path.join(rgb_dir, 'NTIRE2021_Train_HazeFree', x) for x in clean_files] 
        self.noisy_filenames = [os.path.join(rgb_dir, 'NTIRE2021_Train_Hazy', x)       for x in noisy_files ]
...
class DataLoaderVal(Dataset):
    def __init__(self, rgb_dir, target_transform=None):
        ...
        clean_files = sorted(os.listdir(os.path.join(rgb_dir, '')))
        ...
        self.noisy_filenames = [os.path.join(rgb_dir, '', x) for x in noisy_files ]#if is_png_file(x)]
